...
export const creators: Creator[] = [
  {
    ...
    bio: "Kofi is a Ghanaian-British animator and director based in London whose work draws from Akan mythology, Afrofuturist philosophy, and the visual grammar of classic shonen anime. His debut series Nkrumah Rising was ShangoMaji's first commissioned original, blending hand-drawn aesthetics with digital compositing to create a style entirely his own. He has been building the world of Aurum — an Afro-cyberpunk universe set 400 years after the colonisation of Mars — for over six years.",
    origin: "Accra, Ghana / London, UK",
    avatarUrl: pic(1001, 400, 400),
    bannerUrl: pic(1001, 1920, 600),
    genres: ["Afro Cyberpunk", "Mythology & Gods", "Martial Worlds"],
    ...
    titles: [
      ...
      },
      {
        ...
        year: 2024,
        type: "short",
        genres: ["Afro Cyberpunk", "Futures & Sci-Fi"],
        description:
  ...
  },
  {
    ...
    bio: "Amara is a Senegalese-American writer and visual director from Atlanta whose creative practice sits at the intersection of West African oral tradition and contemporary anime narrative structure. Her anthology series Griots of the Infinite draws from Mandinka, Wolof, and Fulani storytelling traditions, reimagining them as an interconnected mythological universe with the scope of a prestige drama. She is one of the most distinctive voices in the new wave of Afro-influenced animation.",
    origin: "Dakar, Senegal / Atlanta, USA",
    avatarUrl: pic(1002, 400, 400),
    bannerUrl: pic(1002, 1920, 600),
    genres: ["Folklore & the Ancient", "Mythology & Gods", "Diaspora Stories"],
    ...
    titles: [
      {
        ...
        year: 2023,
        type: "series",
        genres: ["Folklore & the Ancient", "Diaspora Stories", "Mythology & Gods"],
        description:
      ...
      },
      {
        ...
        year: 2024,
        type: "short",
        genres: ["Diaspora Stories", "Folklore & the Ancient"],
        description:
  ...
  },
  {
    ...
    bio: "Zion is a Jamaican animator and composer from Kingston whose work fuses Caribbean spirituality, dancehall culture, and the kinetic visual energy of classic action anime into something entirely unclassifiable. His series Duppy Wars took the ShangoMaji community by storm with its hand-animated fight sequences and a soundtrack that reconstructs Nyahbinghi drumming through electronic production. He scores everything he directs.",
    origin: "Kingston, Jamaica",
    avatarUrl: pic(1003, 400, 400),
    bannerUrl: pic(1003, 1920, 600),
    genres: ["Martial Worlds", "Spirits & the Unseen", "Folklore & the Ancient"],
    ...
    titles: [
      {
        ...
        year: 2023,
        type: "series",
        genres: ["Martial Worlds", "Folklore & the Ancient", "Spirits & the Unseen"],
        description:
      ...
      },
      {
        ...
        year: 2024,
        type: "short",
        genres: ["Afro Cyberpunk", "Martial Worlds"],
        description:
  ...
  },
  {
    ...
    bio: "Nadia is a Nigerian-Canadian director and graphic novelist from Toronto whose visual language draws from Yoruba visual culture, the aesthetics of 90s OVA anime, and the emotional depth of literary fiction. Her debut feature The Weight of Ori is considered one of the most striking pieces of animation to emerge from the ShangoMaji platform — a deeply personal meditation on identity, spiritual inheritance, and belonging told through a visual style of extraordinary precision.",
    origin: "Lagos, Nigeria / Toronto, Canada",
    avatarUrl: pic(1004, 400, 400),
    bannerUrl: pic(1004, 1920, 600),
    genres: ["Diaspora Stories", "Spirits & the Unseen", "Coming of Age"],
